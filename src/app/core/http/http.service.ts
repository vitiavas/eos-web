...
import { InjectionToken, Injectable, Optional, Inject, Injector } from '@angular/core';
import { AuthInterceptor } from "./interceptors/api-prefix.interceptor";
...
export class HttpService extends HttpClient {
    ...
    constructor(private httpHandler: HttpHandler,
        ...
        if (!this.interceptors) {
            ...
            // this.interceptors = [
            //   this.injector.get(DateInterceptor),
